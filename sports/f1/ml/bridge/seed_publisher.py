...
depending on the full sports.f1.predictor backtest harness or a live race feed.
...
Usage::
    ...
    python -m sports.f1.ml.bridge.seed_publisher --race-id 2026-01-BAHRAIN \\
...
from sports.f1.ml.bridge.redis_publisher import RedisPublisher
