...
class F1Client(SportsDataClient):
    ...
    async def get_driver_profile(self, driver_id: str, season: int | None = None) -> dict:
        ...
        career = _summarize_driver_career(seasons)
    ...
    async def get_constructor_profile(self, constructor_id: str, season: int | None = None) -> dict:
        ...
        career = _summarize_constructor_career(seasons, constructor_id)
...
def _summarize_driver_career(seasons: list[dict]) -> dict:
    title_years = [
        item.get("season")
        for item in seasons
        if item.get("position") == 1 and item.get("season")
    ]
...
def _summarize_constructor_career(seasons: list[dict], constructor_id: str) -> dict:
