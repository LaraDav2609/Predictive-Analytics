"""Tests for the simple rating models in sports.f1.ml.ratings."""
...
def test_bradley_terry_recovers_dominant_driver():
    ...
    from sports.f1.ml.ratings.bradley_terry import fit, predict_h2h
...
def test_bradley_terry_orders_three_drivers_correctly():
    from sports.f1.ml.ratings.bradley_terry import fit
...
def test_plackett_luce_recovers_strict_ordering():
    from sports.f1.ml.ratings.plackett_luce import fit, race_win_probabilities
...
def test_plackett_luce_log_likelihood_finite():
    from sports.f1.ml.ratings.plackett_luce import fit
