"""Tests for sports.f1.ml.core neural-net uncertainty heads — DeepEnsemble + MC dropout.
...
from sports.f1.ml.core.deep_ensemble import DeepEnsemble  # noqa: E402
from sports.f1.ml.core.mc_dropout import mc_dropout_predict  # noqa: E402
