"""Tests for sports.f1.ml.multiplicative — stacking + multi_task uncertainty loss."""
...
from sports.f1.ml.multiplicative.stacking import StackedEnsemble
...
def test_uncertainty_weighted_loss_combines_tasks():
    ...
    import torch
    from sports.f1.ml.multiplicative.multi_task import uncertainty_weighted_loss
