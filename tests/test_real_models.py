...
def test_fuel_correction_shrinks_with_lap_number():
    ...
    from f1_ml.features.fuel_correction import fuel_correct
    laps = pd.DataFrame({
        "lap_number": [1, 25, 50],
...
def test_tire_degradation_recovers_known_slope():
    ...
    from f1_ml.features.tire_degradation import fit_linear
...
def test_tire_degradation_cliff_search_finds_synthetic_cliff():
    ...
    from f1_ml.features.tire_degradation import fit_linear_with_cliff
...
def test_tire_degradation_predict_pace_at_age():
    from f1_ml.features.tire_degradation import DegradationFit, predict_pace_at_age
    fit = DegradationFit(
...
def test_dirty_air_recovers_known_penalty():
    ...
    from f1_ml.features.dirty_air import apply_penalty, fit
...
def test_hierarchical_bayes_recovers_team_ranking():
    ...
    from f1_ml.ratings.hierarchical_bayes import HierarchicalBayesStrength
...
def test_fastf1_compound_normalization():
    from f1_ml.providers.fastf1_provider import _normalize_compound
...
def test_fastf1_race_id_format():
    from f1_ml.providers.fastf1_provider import _race_id
...
def test_fastf1_seconds_or_zero_handles_missing():
    from f1_ml.providers.fastf1_provider import _seconds_or_zero
