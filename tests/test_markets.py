"""Tests for f1_ml.markets — mapper, edge, slippage, kelly.
...
from f1_ml.markets.edge import EdgeOpportunity, MarketQuote, compute_edge
from f1_ml.markets.slippage import FillEstimate, OrderbookLevel, kalshi_limit_fill_prob, walk_book
...
def test_mapper_top_k_probabilities():
    ...
    from f1_ml.markets.mapper import podium_probabilities, top_k_probabilities
...
def test_mapper_h2h_consistency():
    ...
    from f1_ml.markets.mapper import h2h_probability
    from f1_ml.providers.synthetic_provider import SyntheticDriver, SyntheticProvider, SyntheticRaceConfig
    from f1_ml.simulator.race_sim import SimConfig, simulate_race
