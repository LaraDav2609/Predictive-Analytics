...
def test_package_imports():
    ...
    import f1_ml  # noqa: F401
    import f1_ml.common.types  # noqa: F401
    import f1_ml.common.registry  # noqa: F401
    import f1_ml.common.calibration  # noqa: F401
    import f1_ml.providers.base  # noqa: F401
    import f1_ml.providers.fastf1_provider  # noqa: F401
    import f1_ml.features.mini_sectors  # noqa: F401
    import f1_ml.features.tire_degradation  # noqa: F401
    import f1_ml.features.knowable_as_of  # noqa: F401
    import f1_ml.ratings.hierarchical_bayes  # noqa: F401
    import f1_ml.events.dnf_weibull  # noqa: F401
    import f1_ml.events.safety_car_poisson  # noqa: F401
    import f1_ml.core.gbm_pace  # noqa: F401
    import f1_ml.core.conformal  # noqa: F401
    import f1_ml.sequence.lstm_pace  # noqa: F401
    import f1_ml.sequence.transformer_race  # noqa: F401
    import f1_ml.sequence.online_bayes  # noqa: F401
    import f1_ml.strategy.dp_optimal_stop  # noqa: F401
    import f1_ml.multiplicative.multi_task  # noqa: F401
    import f1_ml.soft_signals.llm_extractor  # noqa: F401
    import f1_ml.stretch.diffusion_trajectories  # noqa: F401
    import f1_ml.simulator.race_sim  # noqa: F401
    import f1_ml.markets.kelly  # noqa: F401
    import f1_ml.backtest.walk_forward  # noqa: F401
    import f1_ml.backtest.look_ahead_audit  # noqa: F401
    import f1_ml.bridge.redis_publisher  # noqa: F401


def test_kelly_full_kelly_formula():
    """Full Kelly: P=0.6 model, market implies P=0.5 → f* = 0.2."""
    from f1_ml.markets.kelly import kelly_fraction
...
def test_shrunk_kelly_is_quarter_of_full():
    from f1_ml.markets.kelly import kelly_fraction, shrunk_kelly
...
def test_online_bayes_conjugate_update_shrinks_variance():
    from f1_ml.sequence.online_bayes import GaussianBelief, conjugate_update
...
def test_lookahead_audit_blocks_future_features():
    ...
    import pandas as pd
    from f1_ml.features.knowable_as_of import LookaheadError, assert_no_lookahead
...
def test_lookahead_audit_passes_past_features():
    from datetime import datetime, timedelta
    import pandas as pd
    from f1_ml.features.knowable_as_of import assert_no_lookahead
...
def test_pace_kalman_converges_toward_observations():
    ...
    from f1_ml.features.pace_kalman import KalmanConfig, PaceKalman
...
def test_thin_slice_end_to_end_synthetic_race():
    ...
    from f1_ml.bridge.redis_publisher import InMemoryPublisher
    from f1_ml.common.types import RaceOutcomeProbability
    from f1_ml.markets.mapper import h2h_probability, podium_probabilities, winner_probabilities
    from f1_ml.providers.synthetic_provider import (
        SyntheticDriver,
        SyntheticProvider,
        SyntheticRaceConfig,
    )
...
def test_physical_mode_zero_physics_matches_thin_slice():
    ...
    import numpy as np
    from f1_ml.providers.synthetic_provider import SyntheticDriver, SyntheticProvider, SyntheticRaceConfig
